...
start_server(Pin(STATUS_LED_PIN_NUMBER, Pin.OUT), Pin(MOTOR_LEFT_PIN_NUMBERS[0], Pin.OUT), Pin(MOTOR_LEFT_PIN_NUMBERS[1], Pin.OUT), Pin(MOTOR_RIGHT_PIN_NUMBERS[0], Pin.OUT), Pin(MOTOR_RIGHT_PIN_NUMBERS[1], Pin.OUT))